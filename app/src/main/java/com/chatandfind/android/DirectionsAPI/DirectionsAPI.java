...
public class DirectionsAPI {
    ...
    public static HttpURLConnection getDirection(double myLatitude, double myLongtitude, double destinationLatitude, double destinationLongtitude) throws IOException{
        Uri url = (BASE_URL).buildUpon().appendQueryParameter("origin", myLatitude + "," + myLongtitude).appendQueryParameter("destination", destinationLatitude + "," + destinationLongtitude).appendQueryParameter("sensor", "false").build();
